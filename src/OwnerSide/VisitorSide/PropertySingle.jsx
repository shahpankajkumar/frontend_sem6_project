...
class property extends React.Component {
    ...
    submitForm = () => {
        ...
        const data = {  message }
       // console.log(data)
        axios.post("http://localhost:3000/api/reviewadd", data)
            .then((res) => {
                alert("submitted");
            }).catch((error) => {
                console.log(error);
                        ...
                        <div className="col-lg-8 w3l-news">
                            ...
                            dolor sit amet elit. </p>
                                    ...
                                    <div className="single-bg-white card">
                                        <textarea rows="3" id="comments-input" type="text" placeholder="Add a comment..." onChange={(e) => this.setState({ message: e.target.value })} />
                                        <button className="btn btn-primary"type="button" id="contact-submit" onClick={this.submitForm}>post</button>
                                    </div>
